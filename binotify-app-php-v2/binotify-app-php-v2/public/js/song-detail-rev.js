const onEdit = () => {
  ...
  const songName = nameElmt.innerText.trim();
  const year = yearElmt.innerText.trim();
  const genre = genreElmt.innerText.trim();
  ...
  const songDetailCover = document.getElementsByClassName(
    "song-detail-album-btn"
  )[0];
  ...
  const changeSongContainer = document.getElementsByClassName(
    "song-detail-change-song-container"
  )[0];
...
const onSave = async () => {
  ...
  const inputAudioSong = document.getElementsByClassName("input-audio-song")[0];
  const musicAudioSong =
    document.getElementsByClassName("song-detail-audio")[0];

  const inputCoverSong = document.getElementsByClassName("input-cover-song")[0];
  const imgSongCover = document.getElementsByClassName("song-detail-cover")[0];
  const chosenAlbum = document.getElementsByClassName(
    "song-detail-select-album"
  )[0];
  ...
  const albumBtn = document.getElementsByClassName("song-detail-album-btn")[0];
  albumBtn.removeAttribute("hidden");
